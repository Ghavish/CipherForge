...
async def main():
    ...
    custom_prompt = f"""
    You are the UI Coder. When the Architect sends you a blueprint:
    1. Generate the React/TypeScript code. Focus on highly interactive frontend components.
